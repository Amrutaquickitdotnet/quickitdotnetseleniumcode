...
public class Example_002_DataTypes {
	...
	public static void main(String[] args) {
		...
		int b = 20;
		int c = a+b;
		System.out.println("My additon is "+ c);
		// know the size of data types
		...
		System.out.println("The size of my integer is "+ Integer.SIZE);
		...
		System.out.println("The size of float is "+ Double.SIZE);
